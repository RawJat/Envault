...
export interface NotificationPreferences {
  user_id: string;
  // Email notifications (7 granular categories)
  email_access_requests: boolean; // access_request_received
  email_access_granted: boolean; // access_request_approved/denied, role changes, member removed, invitations
  email_device_activity: boolean; // new_device_access, new_location, unknown_login
  email_security_alerts: boolean; // security_alert, security_advisory, password_changed, email_changed, 2fa events, encryption_failed
  email_project_activity: boolean; // secret_added/updated/deleted, bulk_operation, project CRUD, settings_changed, member joined/left, invitation_sent
  email_cli_activity: boolean; // secrets_pulled, secrets_pushed
  email_system_updates: boolean; // system_update, maintenance, rate_limit_warning, email_failed
  // In-app notifications (7 granular categories)
