...
export function StatusBadge() {
    const [status, setStatus] = useState<"loading" | "operational" | "degraded" | "outage" | "maintenance">("loading");
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                // Fallback to operational but maybe log it? 
                // Or we could have a "unknown" state. For now, default to operational if fail.
