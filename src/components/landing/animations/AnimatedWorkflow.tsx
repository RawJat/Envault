      ...
      <div className="flex size-full flex-col items-stretch justify-between gap-[clamp(0.25rem,1.2vw,0.9rem)] relative max-w-5xl">
        ...
        <div className="flex flex-row items-start justify-between">
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={developerRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-blue-500/40 hover:border-blue-500/60"
            >
              <User className="size-[clamp(1.25rem,2.8vw,1.6rem)] text-blue-500" />
            </Circle>
            <div className="flex flex-col items-center gap-0.5">
              <span className="text-[clamp(0.5rem,1.4vw,0.7rem)] font-mono uppercase tracking-wider font-semibold text-foreground">
                Developer
              </span>
              <span className="text-[clamp(0.4rem,1.1vw,0.55rem)] font-mono uppercase tracking-wider text-muted-foreground">
                Push Secrets
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={localRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-yellow-500/40 hover:border-yellow-500/60"
            >
        ...
        <div className="flex flex-row items-center justify-between relative">
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={cicdRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-purple-500/40 hover:border-purple-500/60"
            >
          ...
          <div className="flex flex-col items-center">
            <Circle
              ref={envaultRef}
              className="size-[clamp(3.6rem,10vw,6rem)] border-2 border-primary/50 bg-background shadow-2xl hover:shadow-primary/20 hover:border-primary/70"
            >
              <Shield className="size-[clamp(1.9rem,4.8vw,3rem)] text-primary" />
            </Circle>
            <div className="flex flex-col items-center gap-0.5 mt-1">
              <span className="text-[clamp(0.55rem,1.6vw,0.95rem)] font-mono uppercase tracking-wider font-bold text-primary">
                ENVAULT
              </span>
              <span className="text-[clamp(0.4rem,1.1vw,0.55rem)] font-mono uppercase tracking-wider text-muted-foreground">
                Secure Hub
          ...
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={stagingRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-indigo-500/40 hover:border-indigo-500/60"
            >
        ...
        <div className="flex flex-row items-end justify-between">
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={teamRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-green-500/40 hover:border-green-500/60"
            >
          ...
          <div className="flex flex-col items-center gap-1">
            <Circle
              ref={prodRef}
              className="size-[clamp(2.8rem,6.5vw,4rem)] border-emerald-500/40 hover:border-emerald-500/60"
            >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 translate-y-[clamp(3.6rem,10vw,6.5rem)] flex items-center gap-1 sm:gap-2 md:gap-3">
          <div className="flex flex-col items-center gap-0.5">
            <Circle
              ref={validateRef}
              className="size-[clamp(2.6rem,6.3vw,3.4rem)] border-orange-500/40 hover:border-orange-500/60"
            >
              <CheckCircle2 className="size-[clamp(1.2rem,2.9vw,1.5rem)] text-orange-500" />
            </Circle>
            <span className="text-[clamp(0.4rem,1vw,0.55rem)] font-mono uppercase tracking-wider text-muted-foreground">
              Validate
            </span>
          </div>
          ...
          <div className="flex flex-col items-center gap-0.5">
            <Circle
              ref={encryptRef}
              className="size-[clamp(2.6rem,6.3vw,3.4rem)] border-red-500/40 hover:border-red-500/60"
            >
          ...
          <div className="flex flex-col items-center gap-0.5">
            <Circle
              ref={rotateRef}
              className="size-[clamp(2.6rem,6.3vw,3.4rem)] border-cyan-500/40 hover:border-cyan-500/60"
            >
