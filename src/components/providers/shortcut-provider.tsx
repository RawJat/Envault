...
export function ShortcutProvider({ children }: { children: React.ReactNode }) {
  ...
  useHotkeys(
    ...
    { enableOnContentEditable: true, enableOnFormTags: true },
  ); // Allow checking help even while typing
  ...
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 0 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 1 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 2 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 3 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 4 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 5 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 6 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 7 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
  useHotkeys(
    ...
    () =>
      document.dispatchEvent(
        new CustomEvent("switch-tab", { detail: { index: 8 } }),
      ),
    { enableOnContentEditable: false, enableOnFormTags: false },
  );
