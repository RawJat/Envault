...
export function CreateProjectDialog({ open: controlledOpen, onOpenChange: controlledOnOpenChange }: CreateProjectDialogProps = {}) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button>
                    ...
                    Create Project
                    <Kbd className="ml-2 h-5 px-1.5 text-[10px] bg-primary-foreground/20 text-primary-foreground border-0">N</Kbd>
                </Button>
            </DialogTrigger>
                    ...
                    <DialogFooter>
                        <Button type="submit" disabled={isSubmitting}>
                            ...
                            <div className="ml-2 flex items-center gap-1">
                                ...
                                <Kbd className="bg-white/20 text-white border-0"><CornerDownLeft className="w-3 h-3" /></Kbd>
                            </div>
                        </Button>
                    </DialogFooter>
                </form>
