...
export function ShareSecretModal({
  ...
  const fetchShares = useCallback(async () => {
    ...
    try {
      const { getSecretSharesWithEmails } =
        await import("@/app/secret-actions");
          ...
          <div>
            ...
            {fetchLoading ? (
              ...
              <div className="text-sm text-muted-foreground">
                No specific shares. Project members still have access.
              </div>
            ) : (
              <div className="space-y-3">
                {shares.map((share) => (
                    ...
                    <div className="flex items-center space-x-3 flex-1 min-w-0">
                      ...
                      <div className="space-y-1 min-w-0">
                        <p className="text-sm font-medium leading-none truncate">
                          {share.username || share.email || "User"}
                        </p>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            secret for{" "}
                            {share.username || share.email || "this user"}? They
                            will no longer be able to view this variable.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
