...
MCP web tokens are automatically cleaned up through a protected cron endpoint. When developing locally in an authorized environment, you need to ensure this cron job is configured.
