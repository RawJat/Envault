...
Once you have email delivery set up, individual users can fine-tune which alerts they receive via the **Notifications** section in their account settings. See the [Notifications guide](/docs/platform/core/notifications) for details on the available categories and defaults.
