...
Read the [Architecture](./architecture) guide to understand how AES-256 E2E encryption functions, and review the [Local Setup](./local-setup) to spin up the local web and backend services.
