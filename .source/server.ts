...
import * as __fd_glob_7 from "../content/docs/core/architecture.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "api/overview.mdx": __fd_glob_1, "cli/commands.mdx": __fd_glob_2, "cli/reference.mdx": __fd_glob_3, "configuration/environment-variables.mdx": __fd_glob_4, "guides/initial-setup.mdx": __fd_glob_5, "guides/installation.mdx": __fd_glob_6, "core/architecture.mdx": __fd_glob_7, "core/projects.mdx": __fd_glob_8, "core/security.mdx": __fd_glob_9, });
