...
import * as __fd_glob_7 from "../content/docs/configuration/environment-variables.mdx?collection=docs"
import * as __fd_glob_6 from "../content/docs/core/security.mdx?collection=docs"
import * as __fd_glob_5 from "../content/docs/core/projects.mdx?collection=docs"
import * as __fd_glob_4 from "../content/docs/core/architecture.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "api/overview.mdx": __fd_glob_1, "cli/commands.mdx": __fd_glob_2, "cli/reference.mdx": __fd_glob_3, "core/architecture.mdx": __fd_glob_4, "core/projects.mdx": __fd_glob_5, "core/security.mdx": __fd_glob_6, "configuration/environment-variables.mdx": __fd_glob_7, "guides/initial-setup.mdx": __fd_glob_8, "guides/installation.mdx": __fd_glob_9, });
