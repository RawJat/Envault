...
import * as __fd_glob_0 from "../content/docs/cli-reference.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"cli-reference.mdx": __fd_glob_0, "core-concepts.mdx": __fd_glob_1, "getting-started.mdx": __fd_glob_2, "index.mdx": __fd_glob_3, });
